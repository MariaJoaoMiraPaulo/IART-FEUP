...
def process_expression(fexpression):
    ...
    with open("train/"+fexpression.name.replace(".txt", ".json"), "w+") as outfile:
        ...
        for expression in train:
            ...
            expression_output.z1 = expression.points[70].z
            expression_output.z2 = expression.points[84].z
            expression_output.z3 = expression.points[77].z
            expression_output.z4 = expression.points[72].z
            expression_output.z5 = expression.points[81].z
            expression_output.z6 = expression.points[48].z
            expression_output.z7 = expression.points[54].z
            expression_output.z8 = expression.points[36].z
            expression_output.z9 = expression.points[47].z
            expression_output.z10 = expression.points[89].z
